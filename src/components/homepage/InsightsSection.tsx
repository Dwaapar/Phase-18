        ...
        <div className="grid-auto-fit-cards">
          {insights.map((insight, i) => (
            <article key={i} className="group cursor-pointer animate-slide-up" style={{ animationDelay: `${i * 0.1}s` }}>
              {/* 
                IMAGE PLACEMENT: /public/images/insights/
                FILES NEEDED:
                - insight1.jpg (600x450px) - Digital transformation themed image
                - insight2.jpg (600x450px) - AI/technology themed image  
                - insight3.jpg (600x450px) - Data/analytics themed image
                
                CONTENT STYLE:
                - Professional, editorial-style images
                - Dark, moody aesthetic matching monks.com
              ...
              */}
              <div className="aspect-[4/3] bg-monks-medium-gray rounded-2xl mb-6 overflow-hidden relative">
                <img
                  src={`/images/insights/insight${i + 1}.jpg`}
                  alt={insight.title}
                ...
                />
                <div className="w-full h-full flex items-center justify-center text-monks-gray" style={{ display: 'none' }}>
